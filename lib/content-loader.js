...
const readContentFile = async ({ fs, slug, filename }) => {
    ...
    const parsedContent = await remark().use(html).use(prism).process(matterResult.content)
